    ...
    >
      {socialLinks.map((link, i) => (
        <motion.a
          ...
          whileTap={{ scale: 0.9 }}
          title={link.label}
          className="w-10 h-10 rounded-xl glass border border-white/10 flex items-center justify-center text-slate-400 hover:text-cyan-400 hover:border-cyan-500/50 transition-all"
        >
          {link.icon}
        </motion.a>
      ))}
